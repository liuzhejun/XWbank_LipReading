...
if __name__ == '__main__':
    ...
    parser.add_argument("--log_step", default=50, type=int, help='print information interval')
    ...
    parser.add_argument("--k", default=0, type=int, help='跑k次')
